...
本模板按照同济大学规范配置了五级标题层级，具体设置如\tabref{tab:heading-levels}所示。

\begin{table}[htbp]
  \centering
  \caption{标题层级设置}\label{tab:heading-levels}
  \renewcommand{\arraystretch}{1.8}
  \begin{tabular}{cccl}
    \toprule
    \textbf{层级} & \textbf{\LaTeX{} 命令} & \textbf{编号格式} & \textbf{示例} \\
    \midrule
    1 & \texttt{\textbackslash chapter}       & 1, 2, 3       & {\heiti\tjfontchapter 1\quad 绪论} \\
    2 & \texttt{\textbackslash section}       & 1.1, 1.2      & {\heiti\tjfontbody 1.1 标题层级示例} \\
    3 & \texttt{\textbackslash subsection}    & 1.1.1, 1.1.2  & {\heiti\tjfontbody 1.1.1 三级标题示例} \\
    4 & \texttt{\textbackslash subsubsection} & A, B, C       & {\heiti\tjfontbody A.\ 段落标题} \\
    5 & \texttt{\textbackslash paragraph}     & a, b, c       & {\heiti\tjfontbody a. 子段落标题} \\
    \bottomrule
  \end{tabular}
\end{table}
...
段落标题适用于需要进一步细分的场景。注意本模板中段落标题使用大写字母（A、B、C）编号，符合同济大学的排版规范。
